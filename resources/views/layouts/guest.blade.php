...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="font-sans text-gray-900 antialiased">
            ...
            <div class="container"><a class="navbar-brand d-inline-flex" href="/"><span class="text-light fs-2 fw-bold ms-2"><img src="{{asset('assets/img/gallery/NOTAP.PNG')}}" width="100" height="100" alt="NOTAP"></span></a>
            <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
               
                <form class="phone"><a class="text-primary" href="#!">
                ...
                <ul class="navbar-nav ml-auto mb-2 mb-lg-0 login">
